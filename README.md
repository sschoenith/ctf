...
author: ["stephen@schoenith.me", "OSID: OS-73546"]
date: "2017-02-20"
subject: "Markdown"
...
<!--
to get install / generator working, install with:
which 7z
  apt install texlive-full
  be careful... this installs a fuck ton of stuff
  https://github.com/noraj/OSCP-Exam-Report-Template-Markdown/issues/1
  https://github.com/Wandmalfarbe/pandoc-latex-template#installation
  https://github.com/Wandmalfarbe/pandoc-latex-template#required-latex-packages
which pandoc
  apt install pandoc
dpkg -s texlive-full
  apt install p7zip-full
locate eisvogel.latex
  cd $eisvogelDir
